...
<!--
یادداشت ارائه: مسئله‌ی محوری این دفاع، حذف یک وظیفه از مدل پیوسته بدون تخریب دانش وظایف دیگر است. مسیر اصلی پایان‌نامه EPALL است و مسیر لایه‌ی تطبیق به‌عنوان یک نتیجه‌ی اکتشافی و ممیزی‌شده ارائه می‌شود.
-->
...
<div class="takeaway">
آسیب جانبی فراموشی در یک مدل مشترک <strong>تصادفی نیست</strong>؛ در ناحیه‌ی هم‌پوشان پیراسنجه‌ها متمرکز است و با رتبه‌بندی حساسیت می‌توان آن را مهار کرد.
</div>
...
<p class="takeaway">تنش اصلی: همان پیراسنجه‌هایی که هدف را به یاد دارند، ممکن است برای وظایف دیگر نیز ضروری باشند.</p>

<!--
یادداشت ارائه: واحد حذف در این پایان‌نامه یک وظیفه‌ی کامل در حالت Task-Incremental است و شناسه‌ی وظیفه هنگام استنتاج در دسترس است.
-->

---

# منشأ آسیب جانبی: هم‌پوشانی پیراسنجه‌ها
...
<div class="cols">
  ...
  <div class="col narrow">
    <p><strong>پیراسنجه‌های انحصاری هدف</strong><br>قابل بازنشانی با خطر کمتر</p>
    <p><strong>پیراسنجه‌های مشترک</strong><br>ویرایش آن‌ها می‌تواند به وظایف فعال آسیب بزند</p>
    <p class="note"><span class="en">PALL</span> اشتراک را ساختاری می‌کند، اما درایه‌های مشترک را بر اساس حساسیت نگه‌داری تفکیک نمی‌کند.</p>
  </div>
</div>

<!--
یادداشت ارائه: تصویر، هم‌پوشانی نقاب زیرشبکه‌ی هدف با اجتماع زیرشبکه‌های فعال را نشان می‌دهد. فرض اصلی این است که آسیب درون ناحیه‌ی مشترک نیز یکنواخت توزیع نشده است.
-->
...
1. آیا حفاظت از درایه‌های مشترک حساس، هم‌زمان سرکوب و نگه‌داری را ممکن می‌کند؟
...
5. آیا سازوکار مشابه در مسیر کم‌پیراسنجه نیز اثرگذار است؟

<p class="takeaway">مشارکت اصلی فقط «یک روش جدید» نیست؛ طراحی روش با تحلیل جفتی، محک هم‌پوشانی، بررسی اجزای روش و محاسبه هزینه همراه شده است.</p>

<!--
یادداشت ارائه: این اسلاید نقشه‌ی راه دفاع است. پاسخ‌ها به‌ترتیب: بله؛ نزدیک به CLPU؛ شواهد مثبت اما مشروط؛ رتبه‌بندی حساسیت؛ و برای مسیر لایه‌ی تطبیق، خیر.
-->
...
<div class="flow">
  ...
  <div class="arrow">←</div>
  <div>رتبه‌بندی با شیب<br>وظایف نگه‌داری‌شده</div>
  <div class="arrow">←</div>
...
# صورت‌بندی: بودجه‌ی حفاظت را روی حساس‌ترین درایه‌ها خرج می‌کنیم
...
<div class="cols top">
  ...
  <div class="col">
    ...
    <p>فقط بالاترین سهم <span class="ltr">ρ</span> از درایه‌های مشترک محافظت می‌شود.</p>
    <h2>۴. ترمیم مهارشده</h2>
    <p>لنگر <span class="ltr">ℓ₂</span> جابه‌جایی درایه‌های حساس را محدود می‌کند؛ بقیه‌ی مسیر آزادتر ترمیم می‌شود.</p>
  </div>
</div>
...
<div class="cols top">
  ...
  <div class="col">
    ...
    <ul>
      ...
      <li>تضمین آغاز تا پایان برای کل درخواست حذف</li>
...
<!--
یادداشت ارائه: وضعیت آزمایشی اصلی Split-CIFAR با 20 دوره به‌ازای هر وظیفه است. دنباله‌ی درخواست درون هر بذر میان روش‌ها مشترک نگه داشته شده است.
-->
...
<table>
  ...
  <tr><td><span class="en">CIFAR-10</span></td><td>بیشترین افت</td><td class="ltr">+0.0092</td><td class="ltr">0.0625</td><td>معنادار نیست</td></tr>
...
<div class="cols">
  ...
  <div class="col narrow">
    ...
    <p class="note">محور، موقعیت درخواست است؛ فقط یک شاخص جانشین برای هم‌پوشانی مورد انتظار، نه کنترل علی آن.</p>
  </div>
</div>
...
<p class="note">اما پراکندگی، ظرفیت را هم تغییر می‌دهد؛ بنابراین اثر علی خالص هم‌پوشانی هنوز جدا نشده است.</p>
...
# بررسی اجزای روش: تنها کیفیت انتخاب تایید می‌شود
...
<div class="cols top">
  <div class="col wide">
    <table>
      ...
      <tr><td>فقط هم‌پوشانی</td><td>افت کمتر، دقت گاه پایین‌تر</td><td>یک بده‌بستان؛ نه غالب مطلق</td></tr>
    </table>
  </div>
  <div class="col narrow">
    <div class="metric"><b>+0.0076</b><span>زیان بیشترین افت بودجه‌ی تصادفی روی CIFAR-10</span></div>
    <div class="metric" style="margin-top:14px"><b>+0.0148</b><span>زیان بیشترین افت بودجه‌ی تصادفی روی CIFAR-100</span></div>
  </div>
</div>
...
<!--
یادداشت ارائه: محاسبه شامل پیراسنجه‌های مقیم، نقاب‌ها، پشتیبان‌های پراکنده و بازپخش است؛ حالت بهینه‌ساز و حافظه‌ی اوج را شامل نمی‌شود.
-->

---

# مسیر PALL-Adapter یک نتیجه‌ی منفی مفید است
...
<div class="cols">
  ...
  <div class="col narrow">
    <ul>
      <li>بدنه‌ی منجمد + لایه‌ی تطبیق مشترک + لایه‌ی تطبیق وظیفه</li>
      <li>بازوهای کامل و یکنواخت عملا یکسان‌اند</li>
      <li>نقاب پیوسته واقعا تغییر می‌کند، اما اثر آغاز تا پایان ندارد</li>
      <li>سرکوب مشاهده‌شده از <strong>بازنشانی مسیر هدف</strong> می‌آید</li>
    </ul>
  </div>
</div>

<p class="takeaway">برای نسخه‌ی بعدی، نقاب مبتنی بر <strong>رتبه</strong> از نقاب مبتنی بر مقدار امیدبخش‌تر است.</p>

<!--
یادداشت ارائه: این مسیر مشارکت دوم ادعاشده نیست. تحلیل نشان می‌دهد انرژی تعارض در دنباله‌ای نازک متمرکز است و ضریب خطی نقاب، درایه‌ی نوعی را به‌قدر کافی تضعیف نمی‌کند.
-->
...
<div class="cols">
  ...
  <div class="col narrow small">
    <p><strong>AUC نزدیک ۰٫۵</strong><br>یک نتیجه‌ی تهی با توان تشخیص پایین؛ نه شاهد حذف</p>
...
<p class="note">دامنه: حذف در سطح وظیفه و حالت <span class="en">Task-Incremental</span>؛ بدون ادعای حذف رکوردی، ذخیره‌سازی، دقیق یا گواهی‌شده.</p>

<!--
یادداشت ارائه: S پیراسنجه حریم خصوصی تفاضلی نیست. حمله‌های مدل‌سایه و ارزیابی رسمی انجام نشده‌اند. دقت تصادفی هدف می‌تواند هم‌زمان با الگوی خطای متفاوت و قابل‌تفکیک رخ دهد.
-->
...
<div class="takeaway">
<strong>EPALL</strong> با محافظت از درایه‌های مشترک حساس، وظیفه‌ی هدف را سرکوب و دقت وظایف فعال را به مرجع جداسازی نزدیک می‌کند—با حالت مقیم کمتر.
</div>
...
<ul>
  ...
  <li>قید اصلی: شواهد هم‌پوشانی مثبت اما غیرعلی؛ حذف دقیق و تضمین حریم خصوصی اثبات نشده است</li>
  <li>گام بعد: دستکاری ظرفیت‌همتراز هم‌پوشانی، ممیزی رسمی‌تر، و نقاب رتبه‌محور</li>
</ul>
