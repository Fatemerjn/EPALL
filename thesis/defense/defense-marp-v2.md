...
<div class="roadmap">
  ...
  <div><b>5</b> بررسی اجزای روش<span>نتیجه‌ی منفی PALL-Adapter</span></div>
...
<p class="warning">واحد حذف در این پایان‌نامه یک وظیفه‌ی کامل در حالت <span class="en">Task-Incremental</span> است.</p>
...
<p class="warning">یک روش می‌تواند افت نگه‌داری کمی داشته باشد، فقط چون اصلا وظیفه‌ی هدف را فراموش نکرده است.</p>
...
# منشأ آسیب جانبی، اشتراک پیراسنجه‌هاست
...
<div class="cols">
  ...
  <div class="col narrow">
    ...
    <div class="warning">اما همه‌ی درایه‌های مشترک به یک اندازه حساس نیستند.</div>
  </div>
</div>
...
<div class="callout">هدف این پایان‌نامه: نزدیک‌شدن به کیفیت نگه‌داری جداسازی کامل، بدون پرداخت کل هزینه‌ی آن.</div>

<!--
CLPU را به‌عنوان مرجع جداسازی کامل معرفی کنید، نه لزوما رقیبی با همان ظرفیت. روش اصلی در سوی مدل مشترک قرار دارد.
-->
...
<div class="steps">
  <div class="step"><b>زیرشبکه‌ی وظیفه</b>نقاب دودویی برای هر وظیفه</div>
  <div class="arrow">←</div>
...
<div class="cols top" style="margin-top:28px">
  ...
  <div class="col"><h2>مسئله‌ی باز</h2><p>در ترمیم، درایه‌های مشترک را با ارزش یکسان می‌بیند.</p></div>
</div>

<p class="warning">شکاف: بودجه‌ی محافظت باید به درایه‌هایی برسد که برای وظایف نگه‌داری‌شده حساس‌ترند.</p>

<!--
EPALL جایگزین کامل PALL نیست؛ منطق شاخه‌محور آن را حفظ می‌کند و مرحله‌ی انتخاب درایه‌ی حساس را به آن اضافه می‌کند.
-->
...
<div class="callout">در ناحیه‌ی مشترک، درایه‌ها را با شیب وظایف فعال رتبه‌بندی می‌کنیم و بودجه‌ی حفاظت را فقط روی حساس‌ترین‌ها می‌گذاریم.</div>
...
<!--
شکل را از راست به چپ توضیح دهید. ورودی انتخاب، شیب بازپخش وظایف فعال است و خروجی، نقاب درایه‌های حساس است.
-->
...
<div class="cols top">
  ...
  <div class="col">
    <h2>انتخاب</h2>
    <p>بالاترین سهم <span class="ltr">ρ</span> از درایه‌های کاندید، با اندازه‌ی دقیق بودجه.</p>
    <h2>هدف ترمیم</h2>
...
<!--
اگر درباره‌ی تساوی بودجه پرسیده شد: کنترل تصادفی دقیقا همان تعداد درایه را از همان پشتیبان کاندید انتخاب می‌کند.
-->
...
<div class="steps" style="margin-top:45px">
  ...
  <div class="arrow">←</div>
  <div class="step"><b>۲. انتخاب</b>شیب نگه‌داری و <span class="en">Top-ρ</span></div>
  <div class="arrow">←</div>
...
# دامنه‌ی تحلیل نظری عمدا محدود است
...
<div class="cols top">
  ...
  <div class="col">
    ...
    <ul>
      ...
      <li>تضمین آغاز تا پایان برای کل درخواست</li>
...
<div class="callout">اگر آسیب از درایه‌های مشترک حساس بیاید، با افزایش هم‌پوشانی باید سود حفاظت انتخابی نیز بیشتر شود.</div>
...
# طرح ارزیابی برای مقایسه‌ی هم‌تراز طراحی شد
...
<!--
وضعیت آزمایشی اصلی Split-CIFAR هشت بذر دارد. مطالعات مبتنی بر دو بذر فقط توصیفی‌اند و در محدودیت‌ها ذکر می‌شوند.
-->
...
<div class="cards">
  ...
  <div class="card salmon-card"><b>حالت مقیم</b><span>مدل، نقاب، پشتیبان و بازپخش چقدر حافظه می‌خواهند؟</span></div>
  <div class="card salmon-card"><b>حریم خصوصی</b><span>آیا رفتار پس از حذف هنوز عضویت را تفکیک‌پذیر می‌کند؟</span></div>
</div>

<!--
تاکید کنید هیچ معیار منفردی به‌تنهایی کافی نیست؛ مخصوصا دقت تصادفی هدف به معنای حذف اثر نیست.
-->
...
<table>
  ...
  <tr class="warn"><td>CIFAR-10</td><td>بیشترین افت</td><td class="ltr">+0.0092</td><td class="ltr">0.0625</td><td>معنادار نیست</td></tr>
...
<!--
این شاهد توصیفی است، نه علی. برای آزمون مستقیم‌تر به جاروب پراکندگی در دو اسلاید بعد بروید.
-->
...
<!--
شاهد به سود پیش‌بینی است، اما پراکندگی ظرفیت را هم تغییر می‌دهد. پس اثر علی خالص هم‌پوشانی هنوز جدا نشده است.
-->
...
# بررسی اجزای روش، ادعای مکانیزمی را باریک کرد
...
<table>
  ...
  <tr><td>فقط هم‌پوشانی</td><td>افت کمتر، دقت گاهی پایین‌تر</td><td>یک بده‌بستان؛ نه غالب مطلق</td></tr>
</table>
...
<p class="caption">محاسبه: پیراسنجه مقیم، نقاب، پشتیبان پراکنده و بازپخش؛ نه حافظه‌ی اوج و حالت بهینه‌ساز.</p>
...
<!--
این اسلاید را کوتاه ارائه کنید. هدف نشان‌دادن این است که کجا روش خوب تعمیم می‌یابد و کجا ظرفیت یا طرح آزمایشی محدودکننده است.
-->
...
# مسیر اکتشافی: کاهش دامنه‌ی به‌روزرسانی با لایه‌ی تطبیق
...
<div class="cols">
  ...
  <div class="col narrow">
    <ul>
      <li>بدنه‌ی منجمد</li>
      <li>لایه‌ی تطبیق مشترک</li>
      <li>لایه‌ی تطبیق مخصوص هر وظیفه</li>
      <li>نقاب نرم تعارض روی مسیر مشترک</li>
    </ul>
    <div class="warning">پرسش ممیزی: آیا نقاب نرم واقعا نقطه‌ی پایان را بهتر می‌کند؟</div>
  </div>
</div>

<!--
این مسیر با هدف PEFT طراحی شد، اما در پایان‌نامه به‌عنوان مشارکت دوم معرفی نمی‌شود؛ نتیجه‌ی اصلی آن بررسی اجزای روش است.
-->
...
# نتیجه‌ی منفی: نقاب نرم اثر آغاز تا پایان نشان نداد
...
<div class="cols top">
  <div class="col">
    ...
    <ul>
      ...
      <li>تغییر شدت نقاب، دقت و WorstDrop را جابه‌جا نکرد</li>
    </ul>
  </div>
  <div class="col">
    <h2>آنچه اثر داشت</h2>
    <ul>
      <li>بازنشانی لایه‌ی تطبیق هدف</li>
...
<div class="callout">سرکوب مشاهده‌شده عمدتا به <strong>بازنشانی مسیر هدف</strong> نسبت داده می‌شود، نه نقاب نرم آگاه از هم‌پوشانی.</div>
...
<div class="cols">
  ...
  <div class="col narrow small">
    <p><strong>۴۰–۴۵٪</strong> درایه‌ها تعارض غیرصفر دارند.</p>
    <p>اما انرژی تعارض در یک <strong>دنباله‌ی نازک</strong> متمرکز است.</p>
    <p>ضریب خطی پیوسته، درایه‌ی معمولی را به‌اندازه‌ی کافی تضعیف نمی‌کند.</p>
    <div class="warning">فرضیه‌ی بعدی: نقاب رتبه‌محور یا بودجه‌ی صریح، نه مقیاس‌گذاری صرف مقدار.</div>
  </div>
</div>

<!--
نقاب واقعا با گاما تغییر می‌کند؛ مشکل خرابی پیاده‌سازی نیست. مشکل این است که تغییر نقاب به تغییر نقطه‌ی پایان تبدیل نمی‌شود.
-->
...
<div class="cols">
  ...
  <div class="col narrow small">
    <p><strong>AUC نزدیک ۰٫۵</strong><br>نتیجه‌ی تهی با توان تشخیص پایین؛ نه شاهد حذف.</p>
...
<!--
S پیراسنجه حریم خصوصی تفاضلی نیست. حمله‌ی مدل‌سایه و ممیزی رسمی انجام نشده و دقت تصادفی هدف تضمین حریم خصوصی نمی‌دهد.
-->
...
<div class="cards">
  <div class="card"><b>حالت</b><span>نیاز به شناسه‌ی وظیفه در استنتاج؛ حذف در سطح وظیفه</span></div>
...
<!--
این محدودیت‌ها ضعف پنهان‌شده نیستند؛ هر کدام مستقیما یک مسیر پژوهشی آینده را تعریف می‌کنند.
-->
...
<div class="cols top" style="margin-top:25px">
  <div class="col">
    ...
    <p>رتبه‌بندی حساسیت با بودجه‌ی ثابت، ارزیابی جفتی، محک هم‌پوشانی و محاسبه هزینه</p>
  </div>
  <div class="col">
    <h2>گام بعد</h2>
    <p>کنترل ظرفیت‌همتراز، نقاب رتبه‌محور، حذف رکورد/کلاس و ممیزی رسمی حریم خصوصی</p>
  </div>
</div>
...
<!--
جمع‌بندی یک‌جمله‌ای: شناخت اینکه کدام پیراسنجه مشترک واقعا حساس است، از حفاظت یکنواخت مؤثرتر است؛ اما حذف رفتاری را نباید با حذف گواهی‌شده یکی دانست.
-->
...
<div class="cols top">
  <div class="col">
    ...
    <p>با کاهش ضریب به‌روزرسانی روی درایه‌های حساس، کران بالای مرتبه‌اول کاهش می‌یابد.</p>
  </div>
  <div class="col">
    <h2>اما نه آغاز تا پایان</h2>
    <ul>
...
# پیوست ۳ — بازتولیدپذیری طرح آزمایشی اصلی
...
<div class="cards">
  ...
  <div class="card"><b>آموزش</b><span>۲۰ دوره به‌ازای وظیفه در وضعیت آزمایشی اصلی Split-CIFAR.</span></div>
  ...
  <div class="card salmon-card"><b>انتقال</b><span>بدنه‌ی ImageNet و هنجارسازی سازگار برای آزمایش PEFT.</span></div>
</div>
...
# پیوست ۴ — تفسیر درست ارزیابی حریم خصوصی
...
<div class="cols top">
  ...
  <div class="col">
    ...
    <div class="warning">S پیراسنجه DP و تضمین حریم خصوصی نیست.</div>
  </div>
</div>
...
<div class="cols">
  ...
  <div class="col narrow small">
    <p>نقاب پیوسته با شدت تعارض تغییر می‌کند.</p>
    <p>اما بازوی کامل، یکنواخت و بدون صعود مشترک نقطه‌های پایانی نزدیک دارند.</p>
    <p>بازنشانی هدف، اثر واضح و تکرارشونده دارد.</p>
    <div class="warning">پس نقاب نرم در این پیاده‌سازی و طرح آزمایشی، پشتوانه‌ی تجربی برای ادعای سازوکاری ندارد.</div>
  </div>
</div>

<!--
نقشه‌ی حرارتی افت ستونی در زمان درخواست‌ها را نشان می‌دهد. آن را شاهد تصویری رفتار بدانید، نه انتساب علی نقاب.
-->
