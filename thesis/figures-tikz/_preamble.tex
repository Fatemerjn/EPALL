...
% عمداً \setdigitfont فراخوانی نمی‌شود: در شکل‌ها همه‌ی ارقامِ ریاضی باید لاتین بمانند.
...
\newcommand{\num}[1]{\text{\lr{#1}}}         % عدد لاتین داخل متن فارسیِ حالت ریاضی
...
% سربرگ پنل: #1 عرض، #2 عنوان فارسی، #3 پایین، #4 بالا
