...
% همه‌ی پانویس‌ها چپ‌چین (چپ‌به‌راست) شوند؛ مطابق دستورالعمل نگارش پایان‌نامه
\setLTRfootnotes
% \usepackage{array}
...
\input{styles/alg-fa}
\setcounter{secnumdepth}{2}  % تا subparagraph هم شماره می‌خوره
\setcounter{tocdepth}{2}     % تا subparagraph هم در فهرست میاد
...
% پانویس‌ها به‌صورت چپ‌چین (چپ‌به‌راست) تنظیم می‌شوند تا واژه‌های لاتین
% مطابق دستورالعمل نگارش، در پایین صفحه از سمت چپ و به خط لاتین درج شوند.
